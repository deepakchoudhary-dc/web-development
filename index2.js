...
function updateCartCount() {
  ...
  cartCount.textContent = list.length / 3; 
}

function addItem(itemName, itemPrice) {
  let count = 1;
  list.push({ itemName, itemPrice, count });
...
function addcart6() {
  list.push(count6);
  list.push("Eggs Benedict");
  list.push(149);
  localStorage.setItem("list", JSON.stringify(list));
      showConfirmation("Eggs Benedict");
